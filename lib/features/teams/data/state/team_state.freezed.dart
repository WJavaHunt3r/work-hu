...
abstract class $TeamStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<TeamModel> teams, ModelState modelState});
}
...
class _$_TeamState extends _TeamState {
  ...
  @override
  String toString() {
    return 'TeamState(teams: $teams, modelState: $modelState)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_teams), modelState);
...
abstract class _TeamState extends TeamState {
  const factory _TeamState(
      ...
      final ModelState modelState}) = _$_TeamState;
