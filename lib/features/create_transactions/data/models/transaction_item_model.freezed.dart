...
class _$_TransactionItemModel implements _TransactionItemModel {
  ...
  @override
  String toString() {
    return 'TransactionItemModel(id: $id, transactionId: $transactionId, transactionDate: $transactionDate, description: $description, userId: $userId, createUserId: $createUserId, points: $points, transactionType: $transactionType, account: $account, credit: $credit, hours: $hours, round: $round)';
  }
...
abstract class _TransactionItemModel implements TransactionItemModel {
  const factory _TransactionItemModel(
      ...
      final RoundModel? round}) = _$_TransactionItemModel;
