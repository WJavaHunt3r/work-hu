    ...
    return SfCircularChart(
        legend: Legend(
            ...
            legendItemBuilder: (String name,
              ...
              return Image(
                  image: AssetImage(data[index].iconAssetPath ?? ""),
                  fit: BoxFit.fitWidth,
                  height: 50.sp);
            }),
        series: <CircularSeries<TeamModel, String>>[
          PieSeries<TeamModel, String>(
              ...
              explode: true,
              dataSource: teams,
              pointColorMapper: (team, index) =>
                  Color(int.parse("0x${team.color ?? ""}")),
              sortFieldValueMapper: (data, _) => data.teamName,
              xValueMapper: (TeamModel data, _) => data.teamName,
              yValueMapper: (TeamModel data, _) =>
                  num.parse(data.coins.toStringAsFixed(2)),
              dataLabelSettings: DataLabelSettings(
                  labelAlignment: ChartDataLabelAlignment.top,
                  labelPosition: ChartDataLabelPosition.inside,
                  isVisible: true,
                  textStyle:
                      TextStyle(fontSize: 20.sp, fontFamily: "Good-Timing"))),
        ],
        centerX: "50%",
        centerY: "50%");
  }
