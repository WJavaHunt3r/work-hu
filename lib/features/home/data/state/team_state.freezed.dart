...
abstract class $TeamStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<TeamModel> teams, bool isLoading, bool isError});
}
...
class _$_TeamState extends _TeamState {
  ...
  @override
  String toString() {
    return 'TeamState(teams: $teams, isLoading: $isLoading, isError: $isError)';
  }
  ...
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(_teams), isLoading, isError);
...
abstract class _TeamState extends TeamState {
  const factory _TeamState(
      ...
      final bool isLoading,
      final bool isError}) = _$_TeamState;
